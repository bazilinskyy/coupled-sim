...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_ViveController p_ViveController;
        ...
        public static SteamVR_Input_ActionSet_ViveController ViveController
        {
            get
            {
                return SteamVR_Actions.p_ViveController.GetCopy<SteamVR_Input_ActionSet_ViveController>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_ViveController = ((SteamVR_Input_ActionSet_ViveController)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_ViveController>("/actions/ViveController")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.ViveController};
        }
    }
}
