...
public class RotateObjFlapLeft : MonoBehaviour
{
    ...
    void Update()
    {
        if (HMI_On == 1)
        {
            ...
            // ---------------------- Goede code die tot nu toe werkt --------------------
            ...
            //    }
                ...
                //    {
                //        float angle = Mathf.Sin(Mathf.PI*2 * Time.time) * (45 / 2) - (45 / 2); //tweak this to change frequency
                //        transform.rotation = originalRot * Quaternion.AngleAxis(angle, Vector3.up);
                //    }
                ...
                //    // smooth transition: if angle == 0, then ...
                //}
            }
        }
    }
