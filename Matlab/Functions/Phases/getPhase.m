...
ph4 = [find(dx<0.01, 1,'first'); find(dx<0.01, 1,'last')];          % Phase 4, AV standstill
ph5 = [find(dx<0.01, 1,'last'); find(pos_rel<-4.69, 1,'first')];    % Phase 5, AV start driving again till the AV is completely past the zebra crossing
